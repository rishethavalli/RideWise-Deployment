...
- [ ] Navigate to: `C:\Users\HP\Desktop\ridewise\ridewise-frontend1`
- [ ] Run: `git init`
- [ ] Run: `git add .`
- [ ] Run: `git commit -m "Initial commit: RideWise frontend with Next.js"`
- [ ] Run: `git remote add origin https://github.com/YOUR_USERNAME/ridewise-frontend1.git`
- [ ] Run: `git branch -M main`
- [ ] Run: `git push -u origin main`
- [ ] ✅ See "Branch 'main' set up to track remote branch" message
...
- [ ] Find and click **ridewise-frontend1**
- [ ] Click **Import**
...
- [ ] **COPY THIS URL**: `https://ridewise-frontend1-xxxxx.vercel.app`
