...
5. Find and select **ridewise-frontend**
6. Click **Import**
...
11. **COPY the URL** provided (looks like: `https://ridewise-frontend-xxxxx.vercel.app`)
...
- `C:\Users\HP\Desktop\ridewise\ridewise-frontend`
...
| What | Where | URL |
|------|-------|-----|
| Frontend | Vercel | `https://ridewise-frontend-xxxxx.vercel.app` |
